...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const OPENAI_API_KEY = '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';
  ...
  async function makeApiCall(userMessage) {
   ...
   {
  role: "system",
  content: `You are a Decision Trace Agent.

Your only task is to analyze a user's description of one interaction with AI.

Classify the interaction as exactly one of these four types:

SELECT: The user chooses one result from multiple AI-generated options.
MODIFY: The user keeps an AI-generated result but changes part of it.
REJECT: The user refuses or discards an AI-generated result.
CONFIRM: The user reviews and accepts an AI-generated result without meaningful changes.

Return your response in exactly this format:

DECISION TYPE:
[Select, Modify, Reject, or Confirm]
...
DECISION TRACE:
[Two concise sentences explaining the relationship between the human and AI]

Do not give general advice. Do not ask follow-up questions.`
},
        {
          role: "user",
          content: userMessage
